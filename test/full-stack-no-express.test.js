...
describe('test block', () => {
  ...
  test('ArrayModelReturns', async () => {
    ...
    // const result2 = await OneModel.read();
    // expect(JSON.parse(JSON.stringify(result2))).toBe(5);
    ...
    expect(JSON.parse(JSON.stringify(result))).toEqual([
      { age: 30, firstName: 'firstName 3', id: 3, lastName: 'lastName 3' },
      { age: 30, firstName: 'firstName 4', id: 4, lastName: 'lastName 4' },
      { firstName: 'firstNamePush3', lastName: 'lastNamePush3' },
      { firstName: 'firstNamePush5', lastName: 'lastNamePush5' },
      { firstName: 'firstNamePush6', lastName: 'lastNamePush6' },
    ]);
    ...
    expect(JSON.parse(JSON.stringify(result))).toEqual([
      { age: 30, firstName: 'firstName 3 - update', id: 3, lastName: 'lastName 3' },
      { age: 31, firstName: 'firstName 4', id: 4, lastName: 'lastName 4' },
      { firstName: 'firstNamePush3', lastName: 'lastNamePush3' },
      { firstName: 'firstNamePush5 - update', lastName: 'lastNamePush5' },
      { firstName: 'firstNamePush6', lastName: 'lastNamePush6' },
    ]);
    ...
    expect(updateResult[0].firstName).toBe('firstName 3 - update');
    expect(updateResult[1].age).toBe(31);
    expect(updateResult[2].firstName).toBe('firstNamePush3');
    expect(updateResult[3].firstName).toBe('firstNamePush5 - update');
    expect(updateResult[4].firstName).toBe('firstNamePush6');
    ...
    expect(updateResult[0].firstName).toBe('firstName 3 - update0');
    expect(updateResult[1].firstName).toBe('firstName 41');
    expect(updateResult[2].firstName).toBe('firstNamePush32');
    expect(updateResult[3].firstName).toBe('firstNamePush5 - update3');
    expect(updateResult[4].firstName).toBe('firstNamePush64');
